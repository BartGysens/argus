...
<table class="argus_afwezigheden_nav">
	<tbody>
		<tr>
			<td id="argus_afwezigheden_nav_previous"><a
				href="<?php print $base_url.'/afwezigheden/'.$prev->format('Y-m-d'); ?>">&lt;
					vorige dag</a></td>
			<td id="argus_afwezigheden_nav_today"><a
				href="<?php print $base_url.'/afwezigheden/'; ?>">vandaag</a></td>
			<td id="argus_afwezigheden_nav_next"><a
				href="<?php print $base_url.'/afwezigheden/'.$next->format('Y-m-d'); ?>">volgende
					dag &gt;</a></td>
		</tr>
	</tbody>
</table>
	...
	<table class="argus_afwezigheden views-table sticky-enabled cols-10">
		<thead>
			...
			<tr style="font-size: smaller;">
				...
				<th class="views-field views-align-center absencesNOK">niet
					gewettigd</th>
				<th class="views-field views-align-center absencesOK">gewettigd</th>
				<th class="views-field views-align-center absencesNOK">niet
					gewettigd</th>
