...
**Description:
Beleidsplannen lets you create segmented plans for future development
in your organisation.

**Benefits:
Introduce a co-creating environment

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Beleidsplannen, as part of argus - a Quality control extension - is
