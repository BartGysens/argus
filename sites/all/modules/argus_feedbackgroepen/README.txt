...
**Description:
Feedbackgroepen gives you a simpel database for your groups.

**Benefits:
Manage your feedbackgroups.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Feedbackgroepen, as part of argus - a Quality control extension - is developed and
