 ...
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_title(){
	return t('per onderwijsvorm');
}

/**
 * Retrieve information for this plugin: description
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_description(){
	return t('De totalen worden weergegeven per onderwijsvorm.');
}

/**
 * Retrieve information for this plugin: type
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_type(){
	return t('staaf');
}
 ...
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_width(){
	return t('100%');
}
 ...
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_height(){
	return t('400px');
}
 ...
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_package(){
 ...
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_data(){
	$data = array(
		array( 'Onderwijsvorm', 'Aantal leerlingen' )
	);
	
	$query = argus_kerncijfers_preprocess_query(
		  'SELECT s.field_klas_onderwijsvorm_value AS onderwijsvorm, COUNT(DISTINCT u.uid) as total '
 ...
 */
function argus_kerncijfers_plugin_leerlingen_per_onderwijsvorm_options(){
	$options = array(
		'legend' => 'none',
		'hAxis' => array(
			'textStyle' => array(
