...
**Description:
Leerplichtbegeleiding is a content-based module for administration in conjunction
with external services of CLB.

**Benefits:
Manage the abscenses of your students.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Leerplichtbegeleiding, as part of argus - a Quality control extension - is
