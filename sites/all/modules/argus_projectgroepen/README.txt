...
**Description:
Projectgroepen gives you a simpel database for your groups.

**Benefits:
Manage your projectgroups.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Projectgroepen, as part of argus - a Quality control extension - is developed and
