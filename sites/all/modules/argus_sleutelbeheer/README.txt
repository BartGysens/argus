...
**Description:
Sleutelbeheer lets you manage your keys in your organisation. Included is a management
for the loaning of these keys.

**Benefits:
Manage the keys of your employees.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Sleutelbeheer, as part of argus - a Quality control extension - is
