...
**Description:
Werkgroepen gives you a simpel database for your groups.

**Benefits:
Manage your workgroups.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Werkgroepen, as part of argus - a Quality control extension - is developed and
