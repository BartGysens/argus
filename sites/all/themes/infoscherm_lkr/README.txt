...
**Description:
Theme developed for monitor systems.

**Benefits:
Share information with your employees through infoscreens.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Theme Infoscherm LKR, as part of argus - a Quality control extension - is developed
