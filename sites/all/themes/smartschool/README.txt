...
**Important notice:
This theme is not provided, nor developed, nor published nor in any means,
a product of the Smartschool development team.

**Description:
Theme inspired by the look&feel of Smartschool.

**Benefits:
Low profile change for easy adaption in your organisation.

**Installation AND Upgrades:
See the INSTALL.txt file.

**Credits:
Theme Smartschool, as part of argus - a Quality control extension - is developed
and maintained by Bart Gysens, employee at KTA 1 Hasselt, part of GO!. This project is
copyrighted by Bart Gysens, being author of the code.
