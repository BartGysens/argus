 ...
 */
function www_kta1_hasselt_be_breadcrumb($variables){
 ...
 */
function www_kta1_hasselt_be_preprocess_block(&$variables) {
...
function www_kta1_hasselt_be_preprocess_html(&$variables) {
	...
	if ($color_scheme != 'default') {
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/style-' .$color_scheme. '.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-1'  &&
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/merriweather-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-2' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/sourcesanspro-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-3' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/ubuntu-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-4' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/ptsans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-5' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/roboto-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-6' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/opensans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-7' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/lato-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-8' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/roboto-condensed-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-9' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/exo-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-10' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/roboto-slab-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-11' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/raleway-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-12' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/josefin-sans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-14' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/playfair-display-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-15' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/philosopher-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-16' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/cinzel-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-17' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/oswald-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-18' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/playfairdisplaysc-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-19' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/cabin-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-20' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/notosans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-22' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/droidserif-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-23' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/ptserif-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-24' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/vollkorn-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-25' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/alegreya-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}	
	...
	if (theme_get_setting('sitename_font_family')=='sff-26' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/notoserif-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-27' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/crimsontext-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-28' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/gentiumbookbasic-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-29' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/volkhov-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-31' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts'.$protocol. '/alegreyasc-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-32' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts' .$protocol. '/montserrat-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-33' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts' .$protocol. '/firasans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-34' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts' .$protocol. '/lora-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-35' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts' .$protocol. '/quattrocentosans-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-36' ||
		...
		drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/fonts' .$protocol. '/juliussansone-font.css', array('group' => CSS_THEME, 'type' => 'file' , 'preprocess' => FALSE));
	}
	 ...
	 */
	drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/local.css', array('group' => CSS_THEME, 'type' => 'file'));
	...
	*/
	...
	if (theme_get_setting('responsive_menu_state')) {
		...
		if (theme_get_setting('responsive_menu_optgroups')) {
			drupal_add_js(drupal_get_path('theme', 'www_kta1_hasselt_be') .'/js/jquery.mobilemenu.js');
		} else {
			drupal_add_js(drupal_get_path('theme', 'www_kta1_hasselt_be') .'/js/jquery.mobilemenu-no-optgroups.js');
		}
        ...
        drupal_add_js(array('www_kta1_hasselt_be' => array('topoptiontext' => $responsive_menu_topoptiontext)), 'setting');
		$responsive_menu_nested = theme_get_setting('responsive_menu_nested');
		...
		$("#main-navigation ul.main-menu, #main-navigation .content>ul.menu").mobileMenu({
            ...
            topOptionText: Drupal.settings.www_kta1_hasselt_be[\'topoptiontext\']
		});
	...
	*/
	...
	drupal_add_js(drupal_get_path('theme', 'www_kta1_hasselt_be') .'/js/isotope/isotope.pkgd.js', array('preprocess' => false));
	...
	if (theme_get_setting('google_map_js')) {
        ...
        drupal_add_js(array('www_kta1_hasselt_be' => array('google_map_latitude' => $google_map_latitude)), 'setting');
		$google_map_longitude = theme_get_setting('google_map_longitude');
        drupal_add_js(array('www_kta1_hasselt_be' => array('google_map_longitude' => $google_map_longitude)), 'setting');
		$google_map_zoom = (int) theme_get_setting('google_map_zoom');
		$google_map_canvas = theme_get_setting('google_map_canvas');
        drupal_add_js(array('www_kta1_hasselt_be' => array('google_map_canvas' => $google_map_canvas)), 'setting');
		
		drupal_add_js('jQuery(document).ready(function($) { 

		if ($("#'.$google_map_canvas.'").length) {
		
			myLatlng = new google.maps.LatLng(Drupal.settings.www_kta1_hasselt_be[\'google_map_latitude\'], Drupal.settings.www_kta1_hasselt_be[\'google_map_longitude\']);
			...
			function initialize() {
				...
				map = new google.maps.Map(document.getElementById(Drupal.settings.www_kta1_hasselt_be[\'google_map_canvas\']),mapOptions);
	...
	drupal_add_css(drupal_get_path('theme', 'www_kta1_hasselt_be') . '/js/meanmenu/meanmenu.css');
	drupal_add_js(drupal_get_path('theme', 'www_kta1_hasselt_be') .'/js/meanmenu/jquery.meanmenu.min.js', array('preprocess' => false));
 ...
 * Override or insert variables into the html template.
 */
function www_kta1_hasselt_be_process_html(&$vars) {
...
function www_kta1_hasselt_be_page_alter($page) {
...
function www_kta1_hasselt_be_form_alter(&$form, &$form_state, $form_id) {
