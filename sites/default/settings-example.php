...
/**********************************************************/
/* IMPORTANT: ADJUST AND RENAME THIS FILE AS settings.php */
/**********************************************************/
 ...
 *
 */
$drupal_hash_salt = 'S2HoEmidziVpA8Ixx3h-tG4YHbK4c3Ccwc_8ra5ggyc';
...
/**
 * Bigger memory allocation is needed when using many roles imported.
 */
...
$conf['cache_default_class'] = 'MemCacheDrupal';
$conf['cache_class_cache_form'] = 'DrupalDatabaseCache';
$conf['memcache_key_prefix'] = 'argus';
//$conf['page_cache_without_database'] = TRUE;
//$conf['page_cache_invoke_hooks'] = FALSE;
